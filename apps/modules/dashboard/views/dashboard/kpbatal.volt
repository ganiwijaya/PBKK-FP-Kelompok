    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="card mb-3 border-0">
                <div class="card-body">
                    <h4>Batalkan KP</h4>
                    Apakah Anda yakin ingin membatalkan KP ini?
                    <hr>
                    {% for kerja in pekerjaan %}
                    {% if kerja.id_pek == id_pek %}
                    <form action="{{ url('/kp/batalya') }}" method="POST">
                        ...
                        <input type="hidden" id="sudahambil" name="sudahambil" value="0">
                        <input type="hidden" id="status" name="status" value="0">
                        <button type="submit" class="btn btn-warning"><i class="fa fa-times"></i> Batal</button>
                    </form>
                    {% endif %}
                    {% endfor %}
                </div>
